...
[[nodiscard]] bool
checkOpenGLShaderCompile(std::vector<OpenGLShader> const &shaders,
                         bool throwOnError = true);
[[nodiscard]] GLuint
triggerOpenGLShaderLink(std::vector<OpenGLShader> const &shaders,
                        bool throwOnError = true);
[[nodiscard]] bool checkOpenGLShaderLink(GLuint shaderProgram,
                                         bool throwOnError = true);
} // namespace abcg
