...
void Castle::initializeGL(GLuint program) {
  ...
  std::array<glm::vec2, 24> positions{
      // Corpo do carro
      glm::vec2{-02.5f, +12.5f}, glm::vec2{-10.5f, +07.5f},
      glm::vec2{-15.5f, -07.5f}, glm::vec2{-02.5f, +12.5f},
      glm::vec2{-02.5f, +12.5f}, glm::vec2{+02.5f, -12.5f},
      glm::vec2{+10.5f, -07.5f}, glm::vec2{+10.5f, -07.5f},
      glm::vec2{+02.5f, +12.5f}, 

      // Roda esquerda frente
      glm::vec2{-08.5f, +10.5f}, glm::vec2{-08.5f, +08.5f},
      glm::vec2{-05.5f, +08.5f}, glm::vec2{-05.5f, +10.5f},

      // Roda direita frente
      glm::vec2{+05.5f, +10.5f}, glm::vec2{+05.5f, +08.5f},
      glm::vec2{+08.5f, +08.5f}, glm::vec2{+08.5f, +10.5f},
      ...
      // Roda direita trás
      glm::vec2{+05.5f, -08.5f}, glm::vec2{+05.5f, -10.5f},
      glm::vec2{+08.5f, -10.5f}, glm::vec2{+08.5f, +-8.5f},
